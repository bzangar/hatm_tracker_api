...
public class HatmController {
    ...
    @PostMapping()
    public HatmDto createHatm(@RequestBody HatmDto hatmDto, @AuthenticationPrincipal UserDetails userDetails){

        return hatmService.createHatm(hatmDto, userDetails);
    }
